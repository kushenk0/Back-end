...
class ProductDetailView(DetailView, CategoryDetailMixin, CartMixin):
...
class CategoryDetailView(CartMixin, DetailView, CategoryDetailMixin):
   model = Category
...
class MakeOrderView(CartMixin, View):
    ...
    def post(self, request, *args, **kwargs):
        ...
        if form.is_valid():
            ...
            messages.add_message(request, messages.INFO, "Дякуємо за Ваше замовлення! Менеджер з Вами зв'яжеться.")
